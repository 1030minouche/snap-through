...
cranOndulation = 3 #nombre de crans bougés pour effectuer l'ondulation
...
def ondulationHoraire():
    tournerCranHoraire(cranOndulation)
    time.sleep_ms(delais)
    tournerCranAntiHoraire(cranOndulation)
    return

def ondulationAntiHoraire():
    tournerCranAntiHoraire(cranOndulation)
    time.sleep_ms(delais)
    tournerCranHoraire(cranOndulation)
    return

def menu(): #menu pour faciliter l'utilisation du moteur
    angleActuel = 0
    reponse = 0
    ...
    while(reponse != 9):
        ...
        print("7 : Faire onduler sens horaire \n")
        print("8 : Faire onduler sens horaire \n")
        print("9 : Quitter \n")
